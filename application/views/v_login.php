...
<div class="login-box">
  ...
  <div class="login-box-body">
    <h3 class="login-box-msg"><i class="fa fa-graduation-cap"></i> Simfoni IKASTIKMA</h3>
    ...
    <form action="<?php echo site_url('login/proses');?>" method="post">
      ...
      <div class="form-group has-feedback">          
          ...
          <a href="<?php echo site_url('welcome'); ?>" class="btn btn-default btn-block btn-flat"> Batal</a>
      </div>
    </form>
...
<!-- /.login-box -->
    ...
    <footer class="footer">
        <div class="container">
            <p class="text-muted">NAS &copy; 2016
            </p>            
        </div>
    </footer>
