...
<div id="container">
  <div id="wrapper">
    ...
    <div id="content">
      <h1>Beranda</h1>
      <div class="box">
        Sistem Informasi STIKES MAHARANI disediakan sebagai sarana untuk para alumni berbagi pengalaman dan informasi tentang dunia kerja. Selain itu, sistem informasi ini juga berguna bagi para pihak yang ingin mengetahui data pribadi alumni STIKES MAHARANI. Menu pencarian data alumni ini dapat dilihat pada menu 'ALUMNI' Bagi para alumni yang masih belum terdaftar pada sistem atau bagi yang menginginkan user & password, silahkan menghubungi pihak pengelola sistem informasi ini pada menu 'KONTAK KAMI'.
      </div>      
    </div>
    <div id="sidebar">
      <h2>Pengumuman</h2>
